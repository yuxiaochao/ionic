...
/**
 * Generated class for the ProblemdocPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-problemdoc',
  templateUrl: 'problemdoc.html',
})
export class ProblemdocPage {
  ...
  initDate(){
    this.initInfo({DOFA005:3}).auditTime(500).subscribe(data=>{
      if(data){
